...
resource "google_identity_platform_tenant_default_supported_idp_config" "microsoft" {
  for_each = { for tenant in var.tenants : tenant.display_name => tenant if tenant.enable_microsoft_idp }
